...
public class CollectorTest {
    private Map<TaskType, List<Task>> groupTasksByType(List<Task> tasks) {
...
class Task {
    ...
    private Task(final String title, final String description, final TaskType type, final LocalDate createdOn) {
